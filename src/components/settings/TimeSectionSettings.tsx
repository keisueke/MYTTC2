...
export default function TimeSectionSettingsComponent() {
  ...
  return (
    <div className="card-industrial">
      {/* ヘッダー（クリックで折りたたみ） */}
      <div 
        className="flex items-center justify-between p-6 cursor-pointer hover:bg-[var(--color-bg-secondary)]/50 transition-colors"
      ...
      {isExpanded && (
        <div className="px-6 pb-6 border-t border-[var(--color-border)]">
          ...
          {!settings.enabled && (
            <p className="text-[var(--color-text-tertiary)] text-sm pt-4">
